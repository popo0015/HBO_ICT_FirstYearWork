/**
 * This file contains global variables that are used in this exam. We deliberatly 
...
/**
 * This is the EASY-TO-PROGRAM dataset of binary questions. It holds the quiz 
 * questions with their corresponding answers in objects
 */
const questionsEasy = [
  {
  ...
  {
    "question": "01101011 01100001 01110010 01101001 01100010 01110101",
    "answer": "karibu"
  },
  {
    "question": "01100100 01101111 01110110 01101001 01111010 01101000 01100100 01100001 01101110 01100101",
    "answer": "dovizhdane"
  },
  {
    "question": "01100111 01110010 01101111 01100101 01110100 01101010 01100101 01110011",
    "answer": "groetjes"
  }
];

/**
 * This is the HARD-TO-PROGRAM dataset of binary questions. It holds only the 
 * answers, so your code needs to prepare the questions on the fly using the 
 * `asciiTable` object below
 */
const questionsHard = ['hello', 'welkom', 'ola', 'karibu', 'dovizhdane', 'groetjes'];

/**
 * Object variable that holds a table representing the entire ASCII dataset. 
 * Each row in the array consists of an array of 5 items. Each item is an array
 * that consists of 5 items:
 * [0] - The octal representation of the character
 * [1] - The hexadecimal representation of the symbol
 * [2] - The binary representation of the symbol
 * [3] - The actual symbol
 * [4] - A description of the symbol
 * 
...
const asciiTable = {
  ...
  "data": [
    ...
    ["210", "88", "10001000", "^", "Modifier letter circumflex accent"],
    ...
    ["327", "D7", "11010111", "x", "Multiplication sign"],
