...
export default class Wordie {
   ...
   */
  public getGuesses(): HTMLDivElement {
    if (this.guessesLeft === 0) {
      document.getElementById('answer').innerHTML = `Correct word: <strong>${this.answer}</strong>`;
    }

    return this.guesses[this.count].writeGuess();
  }
}
